...
import com.example.administrator.myapplication.system.SystemBarTintManager;
import com.example.administrator.myapplication.utils.FlymeUtils;
import com.example.administrator.myapplication.utils.MIUIUtils;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
			...
			setTranslucentStatus(true);
			 ...
			 SystemBarTintManager(this);
			 tintManager.setStatusBarTintEnabled(true);
			 tintManager.setStatusBarTintResource(R.color.status_color);// ֪ͨ��������ɫ
		}
	}
